...
- Anchor local-vs-high-z gap sigma (GR): `1.067`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.049, local-highz gap sigma=1.162, apparent bias p50=-1.621
- z=0.350: inferred H0_GR p50=68.333, local-highz gap sigma=1.273, apparent bias p50=-2.339
- z=0.500: inferred H0_GR p50=68.454, local-highz gap sigma=1.108, apparent bias p50=-2.236
- z=0.620: inferred H0_GR p50=69.274, local-highz gap sigma=0.796, apparent bias p50=-1.419
