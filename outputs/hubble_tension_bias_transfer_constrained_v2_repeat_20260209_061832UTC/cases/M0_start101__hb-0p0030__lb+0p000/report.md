...
- Anchor local-vs-high-z gap sigma (GR): `1.285`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.440, local-highz gap sigma=1.401, apparent bias p50=-2.087
- z=0.350: inferred H0_GR p50=67.735, local-highz gap sigma=1.485, apparent bias p50=-2.832
- z=0.500: inferred H0_GR p50=67.813, local-highz gap sigma=1.327, apparent bias p50=-2.725
- z=0.620: inferred H0_GR p50=68.716, local-highz gap sigma=1.000, apparent bias p50=-1.877
