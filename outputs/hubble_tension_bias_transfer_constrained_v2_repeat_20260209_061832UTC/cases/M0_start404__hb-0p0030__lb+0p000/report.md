...
- Anchor local-vs-high-z gap sigma (GR): `1.173`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.735, local-highz gap sigma=1.274, apparent bias p50=-1.938
- z=0.350: inferred H0_GR p50=68.106, local-highz gap sigma=1.368, apparent bias p50=-2.610
- z=0.500: inferred H0_GR p50=68.281, local-highz gap sigma=1.210, apparent bias p50=-2.486
- z=0.620: inferred H0_GR p50=69.086, local-highz gap sigma=0.908, apparent bias p50=-1.699
