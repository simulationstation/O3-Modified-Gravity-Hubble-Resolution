...
- Anchor local-vs-high-z gap sigma (GR): `1.208`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.052, local-highz gap sigma=1.316, apparent bias p50=-1.612
- z=0.350: inferred H0_GR p50=68.343, local-highz gap sigma=1.416, apparent bias p50=-2.344
- z=0.500: inferred H0_GR p50=68.444, local-highz gap sigma=1.258, apparent bias p50=-2.235
- z=0.620: inferred H0_GR p50=69.257, local-highz gap sigma=0.924, apparent bias p50=-1.444
