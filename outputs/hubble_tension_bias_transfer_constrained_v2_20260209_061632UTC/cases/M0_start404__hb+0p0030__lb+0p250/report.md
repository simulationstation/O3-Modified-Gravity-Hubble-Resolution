...
- Anchor local-vs-high-z gap sigma (GR): `1.122`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.153, local-highz gap sigma=1.220, apparent bias p50=-1.531
- z=0.350: inferred H0_GR p50=68.519, local-highz gap sigma=1.311, apparent bias p50=-2.200
- z=0.500: inferred H0_GR p50=68.690, local-highz gap sigma=1.160, apparent bias p50=-2.072
- z=0.620: inferred H0_GR p50=69.478, local-highz gap sigma=0.860, apparent bias p50=-1.282
