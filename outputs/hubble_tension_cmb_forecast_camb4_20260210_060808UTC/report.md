...
- Generated UTC: `2026-02-10T06:08:38Z`
...
- Near L~100 (actual `106`): median `ΔC/C = -20.61%` (68%: `-25.38%` to `-12.70%`).
- Near L~300 (actual `286`): median `ΔC/C = -11.17%` (68%: `-13.24%` to `-5.44%`).

## Fit to Planck Lensing Bandpowers

- MG draw chi2 (median): `80.400`
- Planck-reference model chi2: `9.041`
- P(draw beats reference): `0.0%`

## Derived Amplitude Proxies

- `A_lens_proxy` median: `0.9517`
- `A_lens_proxy` p16/p84: `0.9460` / `0.9866`
