...
To probe photo-$z$ failure more directly we anchor a fraction of the host-weight proxy to spectroscopic redshifts by overriding catalogue redshifts where spec-$z$ matches exist. Under strict shifted-sky false-match controls (median shifted/true $<0.1$; max $<0.3$ evaluated at $K=20000$), radii $\gtrsim 15^{\prime\prime}$ become coincidence-dominated, so we restrict to the clean regime $r\le 10^{\prime\prime}$. At the maximal common depth in this clean regime ($r=10^{\prime\prime}$, $K=20000$), the Tier-A (strict-quality) override anchors $3.8\%$ (GW200220\_061928), $6.1\%$ (GW200308\_173609) and $7.7\%$ (GW200219\_094415) of the total host-weight proxy in the top three events (median $6.1\%$). The score remains stable or slightly higher: $\Delta\LPD_{\rm tot}=3.634 \rightarrow 3.644$ ($\Delta\LPD_{\rm data}=2.636 \rightarrow 2.647$) under unchanged selection normalisation. Across the tested clean $(r,K)$ grid, $\Delta\LPD_{\rm tot}$ is non-decreasing with spec-$z$ weight coverage.
