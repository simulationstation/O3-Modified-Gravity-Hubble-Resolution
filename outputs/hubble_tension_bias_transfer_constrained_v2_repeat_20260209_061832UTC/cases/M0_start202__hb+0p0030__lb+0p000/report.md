...
- Anchor local-vs-high-z gap sigma (GR): `1.060`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.250, local-highz gap sigma=1.136, apparent bias p50=-1.725
- z=0.350: inferred H0_GR p50=68.455, local-highz gap sigma=1.270, apparent bias p50=-2.508
- z=0.500: inferred H0_GR p50=68.574, local-highz gap sigma=1.108, apparent bias p50=-2.435
- z=0.620: inferred H0_GR p50=69.390, local-highz gap sigma=0.798, apparent bias p50=-1.689
