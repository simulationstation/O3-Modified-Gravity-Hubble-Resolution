...
- Anchor local-vs-high-z gap sigma (GR): `1.187`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.641, local-highz gap sigma=1.298, apparent bias p50=-2.031
- z=0.350: inferred H0_GR p50=67.928, local-highz gap sigma=1.397, apparent bias p50=-2.742
- z=0.500: inferred H0_GR p50=68.063, local-highz gap sigma=1.227, apparent bias p50=-2.651
- z=0.620: inferred H0_GR p50=68.872, local-highz gap sigma=0.904, apparent bias p50=-1.815
