...
- Anchor local-vs-high-z gap sigma (GR): `1.054`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.157, local-highz gap sigma=1.141, apparent bias p50=-1.530
- z=0.350: inferred H0_GR p50=68.541, local-highz gap sigma=1.241, apparent bias p50=-2.200
- z=0.500: inferred H0_GR p50=68.683, local-highz gap sigma=1.092, apparent bias p50=-2.084
- z=0.620: inferred H0_GR p50=69.476, local-highz gap sigma=0.804, apparent bias p50=-1.288
