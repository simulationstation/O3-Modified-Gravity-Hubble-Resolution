...
The present analysis is conditional: it does not re-establish the O3 anomaly detection claim, but asks what follows if that signal is physical. The O3 anomaly replication repository is public on Zenodo (DOI: \href{https://doi.org/10.5281/zenodo.18585598}{10.5281/zenodo.18585598}) and provides the calibrated baseline used here. The follow-up objective is to convert that hypothesis into quantitative predictions for:
...
\begin{itemize}[leftmargin=2em]
\item O3 modified-gravity tension replication repository (Zenodo): DOI \href{https://doi.org/10.5281/zenodo.18585598}{10.5281/zenodo.18585598}.
