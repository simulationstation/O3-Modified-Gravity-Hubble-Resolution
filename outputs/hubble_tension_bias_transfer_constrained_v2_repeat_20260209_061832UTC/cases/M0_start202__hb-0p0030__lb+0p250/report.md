...
- Anchor local-vs-high-z gap sigma (GR): `1.241`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.820, local-highz gap sigma=1.353, apparent bias p50=-2.140
- z=0.350: inferred H0_GR p50=68.063, local-highz gap sigma=1.455, apparent bias p50=-2.929
- z=0.500: inferred H0_GR p50=68.164, local-highz gap sigma=1.280, apparent bias p50=-2.861
- z=0.620: inferred H0_GR p50=68.995, local-highz gap sigma=0.959, apparent bias p50=-2.073
