...
- Anchor local-vs-high-z gap sigma (GR): `1.157`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.008, local-highz gap sigma=1.268, apparent bias p50=-1.665
- z=0.350: inferred H0_GR p50=68.335, local-highz gap sigma=1.378, apparent bias p50=-2.384
- z=0.500: inferred H0_GR p50=68.460, local-highz gap sigma=1.200, apparent bias p50=-2.194
- z=0.620: inferred H0_GR p50=69.296, local-highz gap sigma=0.865, apparent bias p50=-1.294
