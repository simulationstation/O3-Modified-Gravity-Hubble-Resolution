...
- Anchor-based relief (GR-interpreted high-z): `0.245`
- Anchor local-vs-high-z gap sigma (GR): `1.097`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.860, local-highz gap sigma=1.183, apparent bias p50=-1.677
- z=0.350: inferred H0_GR p50=68.127, local-highz gap sigma=1.293, apparent bias p50=-2.410
- z=0.500: inferred H0_GR p50=68.216, local-highz gap sigma=1.147, apparent bias p50=-2.315
- z=0.620: inferred H0_GR p50=69.094, local-highz gap sigma=0.831, apparent bias p50=-1.477
