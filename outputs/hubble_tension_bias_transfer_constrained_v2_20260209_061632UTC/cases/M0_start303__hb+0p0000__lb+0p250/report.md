...
- Anchor local-vs-high-z gap sigma (GR): `1.292`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.804, local-highz gap sigma=1.416, apparent bias p50=-1.866
- z=0.350: inferred H0_GR p50=68.140, local-highz gap sigma=1.518, apparent bias p50=-2.575
- z=0.500: inferred H0_GR p50=68.254, local-highz gap sigma=1.336, apparent bias p50=-2.407
- z=0.620: inferred H0_GR p50=69.114, local-highz gap sigma=0.984, apparent bias p50=-1.486
