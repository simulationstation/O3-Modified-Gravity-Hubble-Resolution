...
- Anchor local-vs-high-z gap sigma (GR): `1.195`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.862, local-highz gap sigma=1.297, apparent bias p50=-1.827
- z=0.350: inferred H0_GR p50=68.131, local-highz gap sigma=1.411, apparent bias p50=-2.554
- z=0.500: inferred H0_GR p50=68.271, local-highz gap sigma=1.238, apparent bias p50=-2.443
- z=0.620: inferred H0_GR p50=69.054, local-highz gap sigma=0.914, apparent bias p50=-1.636
