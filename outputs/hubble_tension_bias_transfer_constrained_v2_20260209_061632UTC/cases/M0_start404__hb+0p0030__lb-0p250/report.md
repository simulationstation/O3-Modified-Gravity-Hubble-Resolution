...
- Anchor local-vs-high-z gap sigma (GR): `0.986`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.129, local-highz gap sigma=1.068, apparent bias p50=-1.529
- z=0.350: inferred H0_GR p50=68.533, local-highz gap sigma=1.166, apparent bias p50=-2.192
- z=0.500: inferred H0_GR p50=68.708, local-highz gap sigma=1.026, apparent bias p50=-2.077
- z=0.620: inferred H0_GR p50=69.467, local-highz gap sigma=0.743, apparent bias p50=-1.313
