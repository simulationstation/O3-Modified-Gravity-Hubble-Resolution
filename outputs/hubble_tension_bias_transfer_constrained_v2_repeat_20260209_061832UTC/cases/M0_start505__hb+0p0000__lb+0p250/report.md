...
- Anchor local-vs-high-z gap sigma (GR): `1.269`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.860, local-highz gap sigma=1.386, apparent bias p50=-1.821
- z=0.350: inferred H0_GR p50=68.117, local-highz gap sigma=1.491, apparent bias p50=-2.546
- z=0.500: inferred H0_GR p50=68.260, local-highz gap sigma=1.311, apparent bias p50=-2.440
- z=0.620: inferred H0_GR p50=69.061, local-highz gap sigma=0.971, apparent bias p50=-1.621
