...
- Anchor local-vs-high-z gap sigma (GR): `1.153`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.623, local-highz gap sigma=1.255, apparent bias p50=-1.875
- z=0.350: inferred H0_GR p50=67.939, local-highz gap sigma=1.361, apparent bias p50=-2.616
- z=0.500: inferred H0_GR p50=68.052, local-highz gap sigma=1.192, apparent bias p50=-2.507
- z=0.620: inferred H0_GR p50=68.904, local-highz gap sigma=0.877, apparent bias p50=-1.682
