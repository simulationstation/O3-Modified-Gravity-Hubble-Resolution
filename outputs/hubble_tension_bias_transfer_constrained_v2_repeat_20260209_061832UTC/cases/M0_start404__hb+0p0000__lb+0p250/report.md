...
- Anchor local-vs-high-z gap sigma (GR): `1.181`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.919, local-highz gap sigma=1.284, apparent bias p50=-1.743
- z=0.350: inferred H0_GR p50=68.324, local-highz gap sigma=1.376, apparent bias p50=-2.402
- z=0.500: inferred H0_GR p50=68.454, local-highz gap sigma=1.223, apparent bias p50=-2.284
- z=0.620: inferred H0_GR p50=69.297, local-highz gap sigma=0.908, apparent bias p50=-1.495
