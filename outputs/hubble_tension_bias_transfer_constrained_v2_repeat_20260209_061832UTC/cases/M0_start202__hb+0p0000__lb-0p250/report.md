...
- Anchor local-vs-high-z gap sigma (GR): `1.043`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.059, local-highz gap sigma=1.118, apparent bias p50=-1.934
- z=0.350: inferred H0_GR p50=68.266, local-highz gap sigma=1.240, apparent bias p50=-2.712
- z=0.500: inferred H0_GR p50=68.358, local-highz gap sigma=1.097, apparent bias p50=-2.641
- z=0.620: inferred H0_GR p50=69.203, local-highz gap sigma=0.787, apparent bias p50=-1.902
