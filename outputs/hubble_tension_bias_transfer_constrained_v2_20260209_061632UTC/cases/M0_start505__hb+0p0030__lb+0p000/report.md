...
- Anchor local-vs-high-z gap sigma (GR): `1.139`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.041, local-highz gap sigma=1.240, apparent bias p50=-1.623
- z=0.350: inferred H0_GR p50=68.337, local-highz gap sigma=1.345, apparent bias p50=-2.332
- z=0.500: inferred H0_GR p50=68.467, local-highz gap sigma=1.177, apparent bias p50=-2.241
- z=0.620: inferred H0_GR p50=69.248, local-highz gap sigma=0.868, apparent bias p50=-1.406
