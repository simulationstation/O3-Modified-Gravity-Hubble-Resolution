...
_command: `scripts/run_realdata_recon.py --out outputs/finalization/highpower_multistart_v2/M0_start303 --seed 303 --mu-init-seed 303 --mu-sampler ptemcee --rsd-mode dr12+dr16_fsbao --include-lensing --cpu-cores 0 --mu-procs 0 --gp-procs 0 --save-chain outputs/finalization/highpower_multistart_v2/M0_start303/samples/mu_chain.npz --mu-steps 3000 --mu-burn 1000 --mu-draws 1600`_
...
| ---------- | ----- | -------- | --------- | ----------- |
| BH (μ=1)   | -     | -        | 0.0119    | -25.59      |
| Tsallis    | 1.719 | -        | 3.51e-11  | -3.13       |
| Barrow     | -     | 1.439    | 3.51e-11  | -3.19       |
| Kaniadakis | -     | β̃=0.964 | 1.27e-07  | -3.43       |


## Diagnostics

- Forward inference acceptance fraction (mean): 0.301
- H0 [km/s/Mpc] (16/50/84): [67.72, 70.57, 73.36]
- Ωm0 (16/50/84): [0.300, 0.354, 0.388]
- r_d [Mpc] (16/50/84): [138.75, 144.02, 149.79]
- σ8,0 (16/50/84): [0.744, 0.769, 0.805]
- S8 (16/50/84): [0.791, 0.829, 0.861]
- σ_cc,jit [km/s/Mpc] (16/50/84): [0.779, 2.6, 5.91]
- σ_sn,jit [mag] (16/50/84): [0.025, 0.0328, 0.0433]
- GP baseline evidence kernel: matern32 (amp=0.108, ell=0.399)
...
| --------------- | ------ | ---------- | --------- | ------------- |
| sn_diagonal_cov | 0.0221 | 9.76e-10   | 9.76e-10  | 2.31e-08      |