...
- Anchor local-vs-high-z gap sigma (GR): `1.088`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.022, local-highz gap sigma=1.191, apparent bias p50=-1.655
- z=0.350: inferred H0_GR p50=68.327, local-highz gap sigma=1.303, apparent bias p50=-2.383
- z=0.500: inferred H0_GR p50=68.470, local-highz gap sigma=1.134, apparent bias p50=-2.198
- z=0.620: inferred H0_GR p50=69.309, local-highz gap sigma=0.802, apparent bias p50=-1.290
