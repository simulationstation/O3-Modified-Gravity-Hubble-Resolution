...
- Anchor local-vs-high-z gap sigma (GR): `1.182`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.951, local-highz gap sigma=1.290, apparent bias p50=-1.735
- z=0.350: inferred H0_GR p50=68.312, local-highz gap sigma=1.375, apparent bias p50=-2.397
- z=0.500: inferred H0_GR p50=68.484, local-highz gap sigma=1.212, apparent bias p50=-2.276
- z=0.620: inferred H0_GR p50=69.272, local-highz gap sigma=0.918, apparent bias p50=-1.511
