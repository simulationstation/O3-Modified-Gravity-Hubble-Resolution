...
- Anchor local-vs-high-z gap sigma (GR): `1.114`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.047, local-highz gap sigma=1.192, apparent bias p50=-1.931
- z=0.350: inferred H0_GR p50=68.272, local-highz gap sigma=1.322, apparent bias p50=-2.701
- z=0.500: inferred H0_GR p50=68.360, local-highz gap sigma=1.165, apparent bias p50=-2.668
- z=0.620: inferred H0_GR p50=69.194, local-highz gap sigma=0.850, apparent bias p50=-1.892
