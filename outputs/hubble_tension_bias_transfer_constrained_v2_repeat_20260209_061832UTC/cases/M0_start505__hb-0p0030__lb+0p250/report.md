...
- Anchor-based relief (GR-interpreted high-z): `0.204`
- Anchor local-vs-high-z gap sigma (GR): `1.328`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.657, local-highz gap sigma=1.448, apparent bias p50=-2.026
- z=0.350: inferred H0_GR p50=67.943, local-highz gap sigma=1.546, apparent bias p50=-2.742
- z=0.500: inferred H0_GR p50=68.058, local-highz gap sigma=1.362, apparent bias p50=-2.641
- z=0.620: inferred H0_GR p50=68.851, local-highz gap sigma=1.036, apparent bias p50=-1.825
