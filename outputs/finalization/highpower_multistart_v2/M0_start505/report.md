...
_command: `scripts/run_realdata_recon.py --out outputs/finalization/highpower_multistart_v2/M0_start505 --seed 505 --mu-init-seed 505 --mu-sampler ptemcee --rsd-mode dr12+dr16_fsbao --include-lensing --cpu-cores 0 --mu-procs 0 --gp-procs 0 --save-chain outputs/finalization/highpower_multistart_v2/M0_start505/samples/mu_chain.npz --mu-steps 3000 --mu-burn 1000 --mu-draws 1600`_
...
| ---------- | ----- | -------- | --------- | ----------- |
| BH (μ=1)   | -     | -        | 0.0157    | -31.46      |
| Tsallis    | 1.694 | -        | 1.22e-08  | -1.49       |
| Barrow     | -     | 1.388    | 1.22e-08  | -3.37       |
| Kaniadakis | -     | β̃=0.937 | 4.24e-05  | -4.14       |


## Diagnostics

- Forward inference acceptance fraction (mean): 0.301
- H0 [km/s/Mpc] (16/50/84): [67.72, 70.73, 73.43]
- Ωm0 (16/50/84): [0.301, 0.354, 0.385]
- r_d [Mpc] (16/50/84): [138.41, 143.88, 149.82]
- σ8,0 (16/50/84): [0.742, 0.770, 0.803]
- S8 (16/50/84): [0.790, 0.829, 0.859]
- σ_cc,jit [km/s/Mpc] (16/50/84): [0.814, 2.64, 5.96]
- σ_sn,jit [mag] (16/50/84): [0.0254, 0.0329, 0.0447]
- GP baseline evidence kernel: matern32 (amp=0.185, ell=0.586)
...
| --------------- | ------ | ---------- | --------- | ------------- |
| sn_diagonal_cov | 0.0209 | 1.56e-07   | 1.56e-07  | 1.55e-05      |