...
- Anchor local-vs-high-z gap sigma (GR): `1.115`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.947, local-highz gap sigma=1.208, apparent bias p50=-1.734
- z=0.350: inferred H0_GR p50=68.302, local-highz gap sigma=1.302, apparent bias p50=-2.403
- z=0.500: inferred H0_GR p50=68.487, local-highz gap sigma=1.150, apparent bias p50=-2.276
- z=0.620: inferred H0_GR p50=69.241, local-highz gap sigma=0.861, apparent bias p50=-1.500
