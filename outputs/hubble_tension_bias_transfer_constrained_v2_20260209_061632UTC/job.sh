...
echo "[job] started \2026-02-09T06:17:13Z"
PYTHONPATH=src .venv/bin/python scripts/run_hubble_tension_bias_transfer_sweep.py \
  --out-root "outputs/hubble_tension_bias_transfer_constrained_v2_20260209_061632UTC" \
  ...
  --heartbeat-sec 30
echo "[job] finished \2026-02-09T06:17:13Z"
