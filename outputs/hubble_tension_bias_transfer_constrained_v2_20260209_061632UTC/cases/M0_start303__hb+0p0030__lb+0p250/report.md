...
- Anchor local-vs-high-z gap sigma (GR): `1.228`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.999, local-highz gap sigma=1.349, apparent bias p50=-1.663
- z=0.350: inferred H0_GR p50=68.335, local-highz gap sigma=1.449, apparent bias p50=-2.367
- z=0.500: inferred H0_GR p50=68.464, local-highz gap sigma=1.267, apparent bias p50=-2.204
- z=0.620: inferred H0_GR p50=69.327, local-highz gap sigma=0.930, apparent bias p50=-1.293
