...
- Anchor local-vs-high-z gap sigma (GR): `1.213`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.448, local-highz gap sigma=1.313, apparent bias p50=-2.081
- z=0.350: inferred H0_GR p50=67.715, local-highz gap sigma=1.427, apparent bias p50=-2.832
- z=0.500: inferred H0_GR p50=67.847, local-highz gap sigma=1.246, apparent bias p50=-2.735
- z=0.620: inferred H0_GR p50=68.678, local-highz gap sigma=0.938, apparent bias p50=-1.869
