...
- Anchor-based relief (GR-interpreted high-z): `0.196`
- Anchor local-vs-high-z gap sigma (GR): `1.353`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.606, local-highz gap sigma=1.481, apparent bias p50=-2.074
- z=0.350: inferred H0_GR p50=67.903, local-highz gap sigma=1.586, apparent bias p50=-2.775
- z=0.500: inferred H0_GR p50=68.044, local-highz gap sigma=1.394, apparent bias p50=-2.599
- z=0.620: inferred H0_GR p50=68.904, local-highz gap sigma=1.040, apparent bias p50=-1.693
