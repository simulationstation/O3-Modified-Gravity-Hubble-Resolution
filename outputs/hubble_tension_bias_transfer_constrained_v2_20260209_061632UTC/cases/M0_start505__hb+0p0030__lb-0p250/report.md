...
- Anchor local-vs-high-z gap sigma (GR): `1.065`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.070, local-highz gap sigma=1.154, apparent bias p50=-1.620
- z=0.350: inferred H0_GR p50=68.319, local-highz gap sigma=1.274, apparent bias p50=-2.344
- z=0.500: inferred H0_GR p50=68.461, local-highz gap sigma=1.111, apparent bias p50=-2.233
- z=0.620: inferred H0_GR p50=69.260, local-highz gap sigma=0.795, apparent bias p50=-1.411
