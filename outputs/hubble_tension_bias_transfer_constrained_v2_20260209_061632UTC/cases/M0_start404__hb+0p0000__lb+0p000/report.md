...
- Anchor local-vs-high-z gap sigma (GR): `1.113`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=68.927, local-highz gap sigma=1.208, apparent bias p50=-1.740
- z=0.350: inferred H0_GR p50=68.336, local-highz gap sigma=1.308, apparent bias p50=-2.401
- z=0.500: inferred H0_GR p50=68.481, local-highz gap sigma=1.149, apparent bias p50=-2.273
- z=0.620: inferred H0_GR p50=69.267, local-highz gap sigma=0.852, apparent bias p50=-1.504
