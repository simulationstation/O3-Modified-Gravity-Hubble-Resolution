...
- Anchor local-vs-high-z gap sigma (GR): `0.990`

## Anchor highlights (GR interpretation)

- z=0.200: inferred H0_GR p50=69.264, local-highz gap sigma=1.055, apparent bias p50=-1.729
- z=0.350: inferred H0_GR p50=68.460, local-highz gap sigma=1.191, apparent bias p50=-2.510
- z=0.500: inferred H0_GR p50=68.563, local-highz gap sigma=1.050, apparent bias p50=-2.453
- z=0.620: inferred H0_GR p50=69.416, local-highz gap sigma=0.733, apparent bias p50=-1.660
